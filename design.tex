...
When a user tries to visit a URL, first the URL goes to blacklist and \spartacus queries its domain information.
If the existing record is found in the blacklist, the browser will block the access. 
